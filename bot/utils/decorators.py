...
def ffmpeg_settings(id, input, FT):
    overly_text="drawtext=fontfile=Faustina-Medium.ttf:text='@Aniimes_Nation':fontsize=21:fontcolor=white:bordercolor=black:borderw=3:x=w-text_w-13:y=20"
    #overly_text="drawtext=fontfile=After_Shok.ttf:text='Aniimes_Nation':fontsize=35:fontcolor=white:bordercolor=black:borderw=7:enable='between(t,0,60)':x=w-text_w-15:y=15"
    ...
    if audio_type == 'opus':
        if resolutio == '480p':
            cmd = f'ffmpeg -hide_banner -loglevel quiet -progress progress-{FT}.txt -i """{input}""" -preset {preset} -vcodec {vcodecs} -crf {crf} -s {resolution} -metadata title="Encoded By @Aniimes_Nation" -metadata:s:v title="@Aniimes_Nation - {resolutio} - {vcodec}"  -metadata:s:a title="@Aniimes_Nation" -metadata:s:s title="@Aniimes_Nation" -map 0:v -vf "{overly_text}" -c:a opus -b:a 64k -map 0:a -c:s copy -map 0:s? -strict -2 """{output}""" -y'
        elif resolutio == '720p':
            cmd = f'ffmpeg -hide_banner -loglevel quiet -progress progress-{FT}.txt -i """{input}""" -preset {preset} -vcodec {vcodecs} -crf {crf} -s {resolution} -metadata title="Encoded By @Aniimes_Nation" -metadata:s:v title="@Aniimes_Nation - {resolutio} - {vcodec}"  -metadata:s:a title="@Aniimes_Nation" -metadata:s:s title="@Aniimes_Nation" -map 0:v -vf "{overly_text}" -c:a opus -b:a 128k -map 0:a -c:s copy -map 0:s? -strict -2 """{output}""" -y'
        else:
            cmd = f'ffmpeg -hide_banner -loglevel quiet -progress progress-{FT}.txt -i """{input}""" -preset {preset} -vcodec {vcodecs} -crf {crf} -metadata title="Encoded By @Aniimes_Nation" -metadata:s:v title="@Aniimes_Nation - {resolutio} - {vcodec}"  -metadata:s:a title="@Aniimes_Nation" -metadata:s:s title="@Aniimes_Nation" -map 0:v -vf "{overly_text}" -c:a opus -b:a 256k -map 0:a -c:s copy -map 0:s? -strict -2 """{output}""" -y'
    
    elif audio_type == 'aac':
        if resolutio == '480p':
            cmd = f'ffmpeg -hide_banner -loglevel quiet -progress progress-{FT}.txt -i """{input}""" -preset {preset} -vcodec {vcodecs} -crf {crf} -s {resolution} -metadata title="Encoded By @Aniimes_Nation" -metadata:s:v title="@Aniimes_Nation - {resolutio} - {vcodec}"  -metadata:s:a title="@Aniimes_Nation" -metadata:s:s title="@Aniimes_Nation" -map 0:v -vf "{overly_text}" -c:a aac -b:a 64k -map 0:a -c:s copy -map 0:s? """{output}""" -y'
        elif resolutio == '720p':
            cmd = f'ffmpeg -hide_banner -loglevel quiet -progress progress-{FT}.txt -i """{input}""" -preset {preset} -vcodec {vcodecs} -crf {crf} -s {resolution} -metadata title="Encoded By @Aniimes_Nation" -metadata:s:v title="@Aniimes_Nation - {resolutio} - {vcodec}"  -metadata:s:a title="@Aniimes_Nation" -metadata:s:s title="@Aniimes_Nation" -map 0:v -vf "{overly_text}" -c:a aac -b:a 128k -map 0:a -c:s copy -map 0:s? """{output}""" -y'
        else:
            cmd = f'ffmpeg -hide_banner -loglevel quiet -progress progress-{FT}.txt -i """{input}""" -preset {preset} -vcodec {vcodecs} -crf {crf} -metadata title="Encoded By @Aniimes_Nation" -metadata:s:v title="@Aniimes_Nation - {resolutio} - {vcodec}"  -metadata:s:a title="@Aniimes_Nation" -metadata:s:s title="@Aniimes_Nation" -map 0:v -vf "{overly_text}" -c:a aac -b:a 256k -map 0:a -c:s copy -map 0:s? """{output}""" -y'
    
    elif audio_type == 'libopus':
        if resolutio == '480p':
            cmd = f'ffmpeg -hide_banner -loglevel quiet -progress progress-{FT}.txt -i """{input}""" -preset {preset} -vcodec {vcodecs} -crf {crf} -s {resolution} -metadata title="Encoded By @Aniimes_Nation" -metadata:s:v title="@Aniimes_Nation - {resolutio} - {vcodec}"  -metadata:s:a title="@Aniimes_Nation" -metadata:s:s title="@Aniimes_Nation" -map 0:v -vf "{overly_text}" -c:a libopus -b:a 64k -map 0:a -c:s copy -map 0:s? """{output}""" -y'
        elif resolutio == '720p':
            cmd = f'ffmpeg -hide_banner -loglevel quiet -progress progress-{FT}.txt -i """{input}""" -preset {preset} -vcodec {vcodecs} -crf {crf} -s {resolution} -metadata title="Encoded By @Aniimes_Nation" -metadata:s:v title="@Aniimes_Nation - {resolutio} - {vcodec}"  -metadata:s:a title="@Aniimes_Nation" -metadata:s:s title="@Aniimes_Nation" -map 0:v -vf "{overly_text}" -c:a libopus -b:a 128k -map 0:a -c:s copy -map 0:s? """{output}""" -y'
        else:
            cmd = f'ffmpeg -hide_banner -loglevel quiet -progress progress-{FT}.txt -i """{input}""" -preset {preset} -vcodec {vcodecs} -crf {crf} -metadata title="Encoded By @Aniimes_Nation" -metadata:s:v title="@Aniimes_Nation - {resolutio} - {vcodec}"  -metadata:s:a title="@Aniimes_Nation" -metadata:s:s title="@Aniimes_Nation" -map 0:v -vf "{overly_text}" -c:a libopus -b:a 256k -map 0:a -c:s copy -map 0:s? """{output}""" -y'        
    return cmd      
...
#         if resolutio == 'auto':
#             if vcodecs == 'libx265':
#                 lq = f'ffmpeg -hide_banner -loglevel quiet -progress progress-{FT}.txt -i """{input}""" -preset {preset} -vcodec libx265 -crf 26 -s 640x480 -metadata title="Encoded By @Aniimes_Nation" -metadata:s:v title="IndiAnime - 480p - libx265"  -metadata:s:a title="IndiAnime" -map 0:v -c:a opus -b:a 64k -map 0:a -c:s copy -map 0:s? -strict -2 """{output}480p.mkv""" -y'
